    ...
    <header className="sticky top-0 z-40 border-b border-white/5 bg-slate-950/72 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 md:px-6">
        ...
        <nav className="hidden items-center gap-5 text-sm text-slate-300 md:flex">
          ...
          <Link href="#skills" className="transition hover:text-cyan-100">Skills</Link>
          <Link href="#projects" className="transition hover:text-cyan-100">Projects</Link>
          <Link href="#contact" className="transition hover:text-cyan-100">Contact</Link>
        </nav>
